...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <div class="flex items-center justify-between pb-4 bg-white dark:bg-gray-900">
        <div>
        <a class="bg-green-500 hover:bg-green-700 active:scale-110 font-bold py-2 px-4 rounded text-white" href="/src/views/create_matter.php">Agregar Clase</a>
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        Lista de Clases por asignar maestro
            <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Informacion de Clases por asignar maestros</p>
        </caption>
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
