...
<section class=" bg-orange-200 rounded-md gap-3 w-96 p-6 shadow-lg hover:shadow-xl">
    <form action="/src/handle_db/edit_user.php" method="post">
        ...
        <input class="" id="contrasena" type="password" name="contrasena"
            placeholder="Para cambiar ingresa una nueva contraseña">
        ...
        <input class="" id="direccion" type="text" name="direccion" placeholder="Ingresa la dirección"
