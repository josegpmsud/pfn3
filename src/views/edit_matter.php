<?php require_once($_SERVER["DOCUMENT_ROOT"] . "/src/section/ini.php");?>
    ...
    <section class="bg bg-orange-200 rounded-md gap-3 w-96 p-6 shadow-lg hover:shadow-xl">
            <form action="/src/handle_db/matter/edit_matter.php" method="post" class="flex flex-col bg bg-orange-200 rounded-md gap-3">
                ...
                <div class="">
                    ...
                    <input class="" type="text" name="nombre_clase" placeholder="Ingresa nombre materia" value="<?= $nombre_clase?>">
                </div>
                <div class="">
